...
export const mainPageContent = {
  ...
  trustedBy: {
    ...
    logos: [
      { src: '/locoCompany/gestmusicLogo.png', alt: 'Gestmusic' },
      { src: '/locoCompany/tv3Logo.png', alt: 'TV3' },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'KAI nace en Gestmusic, parte de Banijay, dentro de la iniciativa Amplify y como proyecto de innovación europeo con apoyo de EIT Culture & Creativity, respaldado por el European Institute of Innovation and Technology. Cuenta además con investigación de Fraunhofer IPK y un núcleo de IA desarrollado por Ugiat Technologies. Para empezar, puedes revisar los planes, descargar el plugin o contactar con el equipo para definir una licencia o suscripción adaptada a tu producción.',
      },
    ],
  },
  ...
  cta: {
    ...
    lead: 'Suscríbete, descarga el plugin y empieza a buscar en tus vídeos con lenguaje natural. KAI se ocupa del trabajo pesado para que tu equipo pueda centrarse en seleccionar, ordenar y contar mejor.',
    primaryCta: 'Ver planes',
    secondaryCta: 'Descargar plugin',
  },
} as const