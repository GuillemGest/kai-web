    ...
    sections: [
      {
        ...
        rows: [
          { label: 'Model', values: ['Cloud subscription', 'Cloud subscription', 'Cloud subscription', 'Cloud subscription'] },
          { label: 'Cloud resources', values: ['Shared', 'Shared', 'Shared', 'Dedicated'] },
          { label: 'On-premise deployment', values: [false, false, false, false] },
          { label: 'Reference price', values: ['Free', '€59/mo', '€149/mo', '€299/mo'] },
        ],
      },
      {
        title: 'Capacity and engines',
        rows: [
          { label: 'Reference capacity', values: ['2 GB · 1 h', '250 GB · 100 h', '250 GB · 100 h', '1 TB · 1,000 h'] },
          { label: 'Video uploads', values: [false, true, true, true] },
          { label: 'Audio engine', values: [false, true, true, true] },
          { label: 'Video and advanced AI', values: [false, false, true, true] },
          { label: 'Export to the editor', values: [false, true, true, true] },
          { label: 'Collaborative work', values: [false, false, false, true] },
          { label: 'Tailored security / compliance', values: [false, false, false, false] },
          { label: 'Operational continuity', values: [false, false, false, false] },
        ],
      },
    ],
  },
