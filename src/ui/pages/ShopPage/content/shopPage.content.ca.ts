    ...
    sections: [
      {
        ...
        rows: [
          { label: 'Modalitat', values: ['Subscripció cloud', 'Subscripció cloud', 'Subscripció cloud', 'Subscripció cloud'] },
          { label: 'Recursos cloud', values: ['Compartits', 'Compartits', 'Compartits', 'Dedicats'] },
          { label: 'Desplegament on-premise', values: [false, false, false, false] },
          { label: 'Preu de referència', values: ['Gratis', '59 €/mes', '149 €/mes', '299 €/mes'] },
        ],
      },
      {
        title: 'Capacitat i motors',
        rows: [
          { label: 'Capacitat de referència', values: ['2 GB · 1 h', '250 GB · 100 h', '250 GB · 100 h', '1 TB · 1.000 h'] },
          { label: 'Pujada de vídeo', values: [false, true, true, true] },
          { label: 'Motor d’àudio', values: [false, true, true, true] },
          { label: 'Vídeo i IA avançada', values: [false, false, true, true] },
          { label: 'Exportació a l’editor', values: [false, true, true, true] },
          { label: 'Treball col·laboratiu', values: [false, false, false, true] },
          { label: 'Seguretat / compliance a mida', values: [false, false, false, false] },
          { label: 'Continuïtat operativa', values: [false, false, false, false] },
        ],
      },
    ],
  },
