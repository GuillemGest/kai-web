    ...
    sections: [
      {
        ...
        rows: [
          { label: 'Modalitat', values: ['Subscripció cloud', 'Subscripció cloud', 'Subscripció cloud'] },
          { label: 'Recursos cloud', values: ['Compartits', 'Compartits', 'Dedicats'] },
          { label: 'Desplegament on-premise', values: [false, false, false] },
          { label: 'Preu de referència', values: ['59 €/mes', '149 €/mes', '299 €/mes'] },
        ],
      },
      {
        title: 'Capacitat i motors',
        rows: [
          { label: 'Capacitat de referència', values: ['250 GB · 100 h', '250 GB · 100 h', '1 TB · 1.000 h'] },
          { label: 'Pujada de vídeo', values: [true, true, true] },
          { label: 'Motor d’àudio', values: [true, true, true] },
          { label: 'Vídeo i IA avançada', values: [false, true, true] },
          { label: 'Exportació a l’editor', values: [true, true, true] },
          { label: 'Treball col·laboratiu', values: [false, false, true] },
          { label: 'Seguretat / compliance a mida', values: [false, false, false] },
          { label: 'Continuïtat operativa', values: [false, false, false] },
        ],
      },
    ],
  },
