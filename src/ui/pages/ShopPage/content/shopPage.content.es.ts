    ...
    sections: [
      {
        ...
        rows: [
          { label: 'Modalidad', values: ['Suscripción cloud', 'Suscripción cloud', 'Suscripción cloud'] },
          { label: 'Recursos cloud', values: ['Compartidos', 'Compartidos', 'Dedicados'] },
          { label: 'Despliegue on-premise', values: [false, false, false] },
          { label: 'Precio de referencia', values: ['59 €/mes', '149 €/mes', '299 €/mes'] },
        ],
      },
      {
        title: 'Capacidad y motores',
        rows: [
          { label: 'Capacidad de referencia', values: ['250 GB · 100 h', '250 GB · 100 h', '1 TB · 1.000 h'] },
          { label: 'Subida de vídeo', values: [true, true, true] },
          { label: 'Motor de audio', values: [true, true, true] },
          { label: 'Vídeo e IA avanzada', values: [false, true, true] },
          { label: 'Exportación al editor', values: [true, true, true] },
          { label: 'Trabajo colaborativo', values: [false, false, true] },
          { label: 'Seguridad / compliance a medida', values: [false, false, false] },
          { label: 'Continuidad operativa', values: [false, false, false] },
        ],
      },
    ],
  },
