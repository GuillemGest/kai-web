  ...
  billing: {
    ...
    plan: {
      ...
      changeDialog: {
        ...
        upgradeNote: 'Millora: s’obrirà una pestanya per confirmar el cobrament de la diferència prorratejada d’aquest període (allà també pots canviar la targeta). Aquesta pantalla s’actualitzarà sola quan acabis.',
        ...
        confirmUpgrade: 'Continua al pagament',
        cancel: 'Cancel·la',
