  ...
  billing: {
    ...
    plan: {
      ...
      manageDialog: {
        ...
        newPlanLabel: 'Pla nou',
        newPriceLabel: 'Preu nou',
      },
      cancelDialog: {
        ...
        finalNote: 'Aquest pas encara no és definitiu: pots reprendre la subscripció en qualsevol moment abans de la data de fi.',
      ...
      reactivateDialog: {
        ...
        finalNote: 'Es reprendrà la renovació automàtica i es cobrarà l’import habitual en la propera data de renovació.',
        confirm: 'Reprèn',
        cancel: 'Tanca',
      ...
      changeDialog: {
        ...
        upgradeNote: 'Millora: s’obrirà una pestanya de Stripe per confirmar el cobrament de la diferència prorratejada d’aquest període (allà també pots canviar la targeta). Aquesta pantalla s’actualitzarà sola quan acabis.',
        ...
        confirmUpgrade: 'Continua per pagar a Stripe',
        cancel: 'Cancel·la',
    ...
    paymentMethod: {
      ...
      hint: 'La targeta predeterminada és la que s’utilitza per cobrar la renovació de la teva subscripció.',
      empty: 'No has afegit cap mètode de pagament.',
      expiresLabel: 'Caduca',
      defaultLabel: 'Predeterminada',
      makeDefaultButton: 'Fer servir per cobraments',
      addCardButton: 'Afegeix una targeta',
      addingCardButton: 'Obrint Stripe…',
      removeButton: 'Elimina',
      removingButton: 'Eliminant…',
      removeConfirmTitle: 'Eliminar targeta',
      removeConfirmBody: 'Estàs a punt d’eliminar la targeta acabada en {last4}. Aquesta acció no es pot desfer.',
      removeConfirmButton: 'Eliminar targeta',
      removeConfirmCancel: 'Cancel·la',
      removeBlockedError: 'No pots eliminar la targeta predeterminada mentre tinguis subscripcions actives. Marca’n una altra com a predeterminada primer.',
      removeGenericError: 'No s’ha pogut eliminar la targeta. Torna-ho a provar.',
    },
    invoices: {
