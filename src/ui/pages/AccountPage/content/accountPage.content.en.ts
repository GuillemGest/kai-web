  ...
  billing: {
    ...
    plan: {
      ...
      changeDialog: {
        ...
        upgradeNote: 'Upgrade: a new tab will open to confirm the charge for this period’s prorated difference (you can also change your card there). This screen will refresh on its own once you’re done.',
        downgradeNote: 'Downgrade: you keep {plan} until {date}, and the new plan starts at your next renewal.',
        confirm: 'Confirm change',
        confirmUpgrade: 'Continue to payment',
        cancel: 'Cancel',
