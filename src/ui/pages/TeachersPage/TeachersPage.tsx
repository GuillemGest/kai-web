    ...
    >
      ...
      <div className="teacher-row-aside" onClick={e => e.stopPropagation()}>
        <div className="teacher-row-links">
          ...
          {teacher.socialUrl && (
            <a href={teacher.socialUrl} target="_blank" rel="noopener noreferrer" className="teacher-ext-link" aria-label={t.teacherSocialAria}>
              Social ↗
            </a>
          )}
          {teacher.extraUrl && (
            <a href={teacher.extraUrl} target="_blank" rel="noopener noreferrer" className="teacher-ext-link" aria-label={t.teacherWebAria}>
              Web ↗
            </a>
          )}
        </div>
...
export function TeachersPage() {
  ...
  useEffect(() => {
    teacherRepository.listPublic()
      .then(setTeachers)
      .catch(e => setError(e instanceof Error ? e.message : t.teachersError))
    ...
    <>
      ...
      <div className="container">
        <div className="teachers-page">
          <h1 className="teachers-page-title">{t.teachersTitle}</h1>
          ...
          <div className="teachers-roster">
            {loading
              ...
              : teachers.length === 0
                ? <p className="teachers-empty">{t.teachersEmpty}</p>
