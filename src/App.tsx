...
import { OnboardingReturn } from './features/companies/OnboardingReturn'
        ...
        <UserCoursesProvider>
          <BrowserRouter basename={import.meta.env.BASE_URL}>
            <Routes>
              ...
              <Route path="/onboarding/complete" element={<OnboardingReturn />} />
              <Route path="/onboarding/retry" element={<OnboardingReturn />} />
            </Routes>
          </BrowserRouter>
        </UserCoursesProvider>
      </AuthProvider>
